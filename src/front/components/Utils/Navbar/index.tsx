...
export const Navbar = () => {
  ...
  const [navbarOptions, setOptions] = useState([
    ...
    {
      name: "Customers",
      isActive: checkIfOptionInitActive("customers"),
      options: [
        {
          name: "List",
          ...
          isActive: checkIfSubOptionInitActive("customers/list"),
        },
        {
          name: "Form",
          ...
          isActive: checkIfSubOptionInitActive("customers/form"),
        },
      ],
    },
    {
      name: "Sales",
      isActive: checkIfOptionInitActive("sales"),
      options: [
        {
          name: "List",
          route: "sales/list",
          blocked: !checkIfHasPermission(context.user, "sales", "read", false),
          isActive: checkIfSubOptionInitActive("sales/list"),
        },
      ],
    },
    {
